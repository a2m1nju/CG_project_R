...
=======
bool isDashing = false; 
float dashTimer = 0.0f; // �뽬 ���� �ð�
const float DASH_DURATION = 1.0f; // �뽬 ���� �ð� (1��)
const float DASH_COOLDOWN = 3.0f; // �뽬 ���� ��� �ð� (3��)
float dashCooldownTimer = 0.0f; // ���� ��� �ð� Ÿ�̸�
const int DASH_COST = 7; // �뽬�� �ʿ��� ���� ����
...
=======
	float dashR = 1.0f, dashG = 1.0f, dashB = 0.0f; // �⺻ ���� (���)
	...
	if (isDashing) {
		...
		dashStr = "CD: " + std::to_string((int)(dashCooldownTimer * 10) / 10.0f) + "s";
		dashR = 0.5f; dashG = 0.5f; dashB = 0.5f; // ȸ��
	}
	else if (coinCount >= DASH_COST) {
		dashStr = "DASH ";
		dashR = 0.0f; dashG = 1.0f; dashB = 0.0f; // �ʷ�
	}
	else {
		dashStr = "NEED " + std::to_string(DASH_COST - coinCount) + " COINS FOR DASH";
		dashR = 1.0f; dashG = 0.5f; dashB = 0.0f; // ��Ȳ
	}

	// �ؽ�Ʈ�� ȭ�� �߾� �ϴܿ� ������ ǥ�� (��: Y=900)
	// �ؽ�Ʈ�� �׸� ���� Outline �Լ� ��� ���� renderTextTTF�� ����Ͽ� ������ �����մϴ�.
...
=======
		...
		// ���� �ִϸ��̼� (�뽬 �߿��� �Ϲ� ������ ���ƾ� ��. isDashing�� isMoving�� ���ÿ� ������� �ʵ��� ����)
...
=======
			...
			// ���� �ǵ�� 
			if (isDashing) printf("�̹� �뽬 ���Դϴ�.\n");
			if (isMoving) printf("�����̴� �߿��� �뽬�� ����� �� �����ϴ�.\n");
			if (dashCooldownTimer > 0.0f) printf("���� ��� �ð� (%.1f��)�� ���ҽ��ϴ�.\n", dashCooldownTimer);
			if (coinCount < DASH_COST) printf("������ �����մϴ� (�ʿ�: %d, ����: %d)\n", DASH_COST, coinCount);
>>>>>>> ba873008b972d650864da5f752e6c62a13f6e228
		}
	}
}
